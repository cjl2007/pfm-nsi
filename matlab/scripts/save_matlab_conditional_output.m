function save_matlab_conditional_output(cifti_path, out_dir)
% Save MATLAB conditional reliability outputs for comparison with Python.
%
% Example:
%   save_matlab_conditional_output('/path/to/Data.dtseries.nii', '/tmp/pfm_nsi_out')
...
out_path = fullfile(out_dir, 'ConditionalReliability_matlab.mat');
save(out_path, 'OUT_10m', '-v7');
